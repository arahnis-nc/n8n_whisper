...
exports.spaceFields = [
    ...
    },
    {
        ...
        type: 'boolean',
        default: false,
        description: 'Whether to extract images from pages, generate AI descriptions, and replace image tags with descriptions. Note: Requires AI Vision API credential to be configured.',
        displayOptions: {
            show: {
                operation: ['getSpaceContent'],
                resource: ['space'],
...
//# sourceMappingURL=Confluence.node.description.js.map